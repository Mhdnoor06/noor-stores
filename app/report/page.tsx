...
import { getBillsBetween, getRepaymentsBetween, getSettings } from "@/lib/db";
import { Bill, CreditEntry } from "@/lib/types";
...
export default function ReportPage() {
  ...
  const load = useCallback(async (d: string) => {
    ...
    try {
      ...
      const [b, r] = await Promise.all([getBillsBetween(start, end), getRepaymentsBetween(start, end)]);
      setBills(b);
      setRepays(r);
    } catch (e) {
